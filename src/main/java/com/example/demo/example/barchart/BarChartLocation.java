...
public class BarChartLocation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String returnurl = "E:\\workstudy\\loverer-poi-demo-master\\poi-demo\\barchartresult.docx";  // 结果文件
        final String templateurl = "E:\\workstudy\\demo\\ceshi.docx";  // 模板文件
    ...
    public static void doCharts1(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        // 第五个图表-饼图
        POIXMLDocumentPart poixmlDocumentPart4 = chartsMap.get("ccc");
